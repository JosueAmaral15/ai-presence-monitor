...
Status: implemented and validated on `codex/task-022-diagnosis-engine`.
...
- [x] documentation completed; task commit and local `develop` integration are
      the remaining session-close steps.
