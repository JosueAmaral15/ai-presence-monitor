...
**Prioridade**: Alta
**Status**: fases 1 a 7 integradas localmente em `develop`; implementacao da
Fase 8 validada na task branch e aguardando integracao local
...
- [x] Recuperacao one-shot opcional implementada e validada com 271 testes em
      ...
      emitido. Integracao local em `develop` ainda pendente.
