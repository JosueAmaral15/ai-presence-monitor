...
- [x] Publicar o registro do upgrade operacional em `develop` e `main`.
- [x] Reconciliar autorizacao persistente de `continue` para AI-workers.
...
- [ ] Validar um unico `continue` nativo pos-upgrade na sessao exata.
